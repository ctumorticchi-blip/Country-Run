...
export const DEFAULT_ECONOMIC_ENGINE_CONFIG: EconomicEngineConfig = {
  growth: {
    ...
    externalEurozoneWeight: 0.3,
    externalTradeWeight: 0.1,
    confidenceWeight: 0.4,
    productivityPassthrough: 0.5,
    noiseStdDev: 0.3,
  },
  potentialGrowth: {
  ...
  debt: {
    ...
    baselineSpread: 0.5,
    riskPremiumPerConfidencePoint: 0.03,
  ...
  productivity: {
    ...
    infrastructureEffectPerBillion: 0.002,
    researchDelayTurns: 15,
    researchEffectPerBillion: 0.003,
    researchUncertainty: 0.5,
    educationDelayTurns: 30,
    educationEffectPerBillion: 0.0015,
